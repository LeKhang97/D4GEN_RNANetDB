...
int main(int argc, char** argv){
    string optlist =
        ...
        "                                    SC1 (side chain beads), allatom, allatomCG, RNAallatom, RNAallatomCG, or N1N9 (default=CA)\n"
    ...
    vector<string> possibler { "CA", "CB", "BB", "SC1", "allatom", "allatomCG", "backbone", "sidechains", "sidechainsCG", "RNAallatom", "RNAallatomCG", "N1N9" };
    ...
    //bool allatom = (cacbbb == "allatom" or cacbbb == "backbone" or cacbbb == "sidechains" or cacbbb == "RNAallatom") ? true : false;
    ...
    else if (cacbbb == "RNAallatom"){total = 3655;}
    else if (cacbbb == "RNAallatomCG"){total = 351;}
    else if (cacbbb == "N1N9"){total = 10;}
    else {total = 210;} // CA, CB, BB, SC1

    string dontplot = (allatom) ? " 1" : ""; // Prevent the creation of 14028 (allatom), or 3240 (backbone), or 3916 (sidechains) [or 3655 (RNAallatom)] plots
    ...
    ******************************/
    ...
    else if (cacbbb == "RNAallatom") atypes = set_RNAallatom();
    else if (cacbbb == "RNAallatomCG") atypes = set_RNAallatomCG();
    else if (cacbbb == "N1N9") atypes = set_N1N9();
    else atypes = set_SC1();
...
*/
    ...
    for (auto line : filevec){
        string threeletter = line.substr(17,3);
        threeletter.erase(remove(threeletter.begin(),threeletter.end(),' '),threeletter.end()); // for RNA or DNA one-letter residue names
        string oneletter = three2one[threeletter];
