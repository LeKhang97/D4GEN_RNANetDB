...
int main(int argc, char** argv){
    ...
    string optlist =
        ...
        "                                    SC1 (side chain beads), allatom, allatomCG, RNAallatom, RNAallatomCG, or N1N9 (default: parameters.log)\n"
    ...
    vector<string> possibler { "CA", "CB", "BB", "SC1", "allatom", "allatomCG", "sidechains", "sidechainsCG", "backbone", "RNAallatom", "RNAallatomCG", "N1N9" };
